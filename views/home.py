...
def render():
    ...
    # Hero Section — fully HTML-driven for perfect centering
    st.markdown("""
    <div style='text-align: center; padding: 48px 0 8px 0;'>
        ...
        <h3 style='font-size: 1.35rem; color: #38BDF8; font-weight: 600;
                   margin: 0 0 22px 0; text-transform: uppercase;'>
            "SEE YOUR RESUME THROUGH THE EYES OF RECRUITERS."
        </h3>
        <p style='font-size: 1rem; color: #94A3B8; max-width: 640px;
    ...
    # Centered CTA button via HTML — avoids Streamlit column width issues
        ...
        for col, (icon, title, desc) in zip(cols, row_features):
            with col:
                ...
                <div class="hirelens-card" style="height: 100%; min-height: 170px;">
                    ...
                    <p style="color: #94A3B8; font-size: 0.82rem; line-height: 1.55;
